...
class Message:
    def __init__(self, selector, sock, addrs, request):
    ...
    def _set_selector_events_mask(self, mode):
        ...
        if mode == 'r':
            ...
            raise ValueError(f"Invalide events masks mdoe {repr(mode )}")
    ...
    def _create_message(self, *, content_bytes, content_type,
        ...
        message_hdr = struck.pack(">H", len(jsonheader_bytes))
    ...
    def close(self):
        print("closing connection to", self.addrs)
        try:
    ...
    def process_response(self):
        ...
        if self.jsonheader['content-type'] == 'text/json':
            ...
            print(f'Received response {repr(self.response)} from {self.addrs}')
